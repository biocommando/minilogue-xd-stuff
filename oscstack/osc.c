...
{
    if (value == 0) waveform[wi] = OSC_SAW;
    else if (value == 1) waveform[wi] = OSC_SQUARE;
    else if (value == 2) waveform[wi] = OSC_TRIANGLE;
    else if (value == 3) waveform[wi] = OSC_SINE;
    else if (value == 4) waveform[wi] = OSC_WT;
}
